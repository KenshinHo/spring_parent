package com.kenshin.base.controller;
...
import com.kenshin.base.service.CityService;
...
public class CityController {
	...
	public Result listBySQLPage(@RequestBody Map searchMap , @PathVariable int page, @PathVariable int size){
		System.out.println("ishot=" +searchMap.get("ishot"));
		Page<City> pageList = cityService.findSearchPage((String)searchMap.get("ishot"), page, size);
		return  new Result(true,StatusCode.OK,"查询成功",  new PageResult<City>(pageList.getTotalElements(), pageList.getContent()) );
	}
